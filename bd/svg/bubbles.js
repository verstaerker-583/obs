...
function bubbles() {
	...
	switch (PageName) {
		case "start":
			...
			bubble("Lutz Jäkel", "12.5%", "Lutz");
			bubble("Markus Mauthe", "37.5%", "Markus");
			break;
		case "cam":
			r = 305;
			background();
			bubble("Lutz Jäkel", "12.5%", "LutzBackground");
			bubble("Markus Mauthe", "37.5%", "MarkusBackground");
			break;
		case "cams":
		...
		case "finish":
			...
			bubble("Lutz Jäkel", "12.5%", "LutzYT");
			bubble("Markus Mauthe", "37.5%", "MarkusYT");
			break;
	}
	banner();
}

...
streamingLayout = {
	{"OBS", nil, "Color LCD", nil, hs.geometry.rect(292, 97, 0, 737), nil}
}

streamingLayoutFotoMagico = {
	{"FotoMagico 5", nil, "Color LCD", nil, hs.geometry.rect(-990, -622, 950, 0), nil},
	{"OBS", nil, "Color LCD", nil, hs.geometry.rect(40, 0, 950, 737), nil}
}
...
--		"open -a 'OBS' --args --collection 'gp' --disable-updater --profile 'gpYTsq' --unfiltered_log --verbose --enable-media-stream --start-streaming"
function appsStart()
	hs.execute(
		"open -a 'OBS' --args --collection 'gp' --disable-updater --profile 'gpYTsq' --unfiltered_log --verbose --enable-media-stream"
	)
end
...
hs.hotkey.bind({"cmd", "alt", "ctrl"}, "s", appsStart)
